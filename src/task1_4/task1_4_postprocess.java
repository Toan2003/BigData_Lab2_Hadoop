...
public class task1_4_postprocess {
  ...
  public static class IntSumReducer
    ...
    public void reduce(Text key, Iterable<Text> values,
      ...
      String result ="";
      for (Text val : values) {
        String[]temp = val.toString().split("\\s+");
  ...
  public static class CombineOutputFiles {
    ...
    public static void outputMTXFiles(String outputAddr) throws IOException {
        ...
        String outputFile = outputAddr + "/TXT/output.txt";
  ...
  public static void main(String[] args) throws Exception {
    ...
    Configuration conf = new Configuration();
    Job job = Job.getInstance(conf, "Lab2 task1_4_preprocess");
    job.setJarByClass(task1_4_postprocess.class);
